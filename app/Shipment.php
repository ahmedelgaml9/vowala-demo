...
class Shipment extends Model {
    ...
    protected $fillable = array('name', 'desc', 'desc','name_ar','desc_ar','active','phone','photo');
    ...
    public function  Shipment_price_zone(){
        return $this->hasMany('App\ShipmentPrice', 'shipment_id');
    }
    ...
    {
        if ($image) {
            $dest = 'admin-assets/images/shipments/';
