...
class PaymentController extends Controller {
    ...
    public function __construct(Request $request, Payment $model) {
    ...
    public function store() {
        ...
        if ($insert) {
            \Session::flash('flash_message', ' payments successfully added'); //<--FLASH MESSAGE
    ...
    public function update($id) {
        ...
        if ($update) {
            \Session::flash('flash_message', 'payments updated successfully'); //<--FLASH MESSAGE
           
            return redirect('admin/payment');

        } else {
            \Session::flash('flash_message', 'Adding payments not complete, Try agin later '); //<--FLASH MESSAGE
    ...
    public function destroy($id) {
        ...
        if ($delete) {
            \Session::flash('flash_message',  'payments successfully deleted.'); //<--FLASH MESSAGE
           
            return redirect('admin/payment');

        } else {
            \Session::flash('flash_message', 'deleting payments not complete, Try again  later ');
