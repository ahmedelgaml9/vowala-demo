...
<div class="fixed-action-btn">
    <a class="btn-floating btn-large red  " href="{{ url('productCoordinator/catalogs/create')}}">
...
<div class="card invoices-card">
    <div class="card-content">
        ...
        <span class="card-title">Products Catalogs</span>
        <table class="responsive-table bordered">
            ...
            <tbody class="data">
                @include('coordinators.productCoordinator.catalog.loop')
            </tbody>
        </table>
        {!! $rows->render() !!}
    </div>
