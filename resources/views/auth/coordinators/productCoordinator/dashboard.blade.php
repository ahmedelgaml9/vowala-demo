...
<html lang="en">
    <head>
        <!-- Title -->
        <title>Discovery |  Coordinator Account </title>
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3 m3">
                            <span class="chapter-title">Discovery </span>
                        </div>
            ...
            <aside id="slide-out" class="side-nav white fixed">
                <div class="side-nav-wrapper">
                    ...
                    <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                      <li class="no-padding">
                          <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">shopping_basket</i> Catalogs<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                          <div class="collapsible-body">
                              <ul>
                                <li class="no-padding "><a class="waves-effect waves-grey " href="{{ url('/productCoordinator/catalogs') }}"> <i class="material-icons">shopping_cart</i> Catalog</a></li>
                                <li class="no-padding "><a class="waves-effect waves-grey " href="{{ url('/productCoordinator/import-from-excel') }}"><i class="material-icons"><i class="material-icons">import_export</i></i>Import Catalogs </a></li>
                              </ul>
                          </div>
                      </li>
                        <li class="no-padding"><a class="waves-effect waves-grey" href="{{ url('/productCoordinator/products-request') }}"><i class="material-icons">settings_input_svideo</i>products</a></li>
                       </ul>
                    <div class="footer">
