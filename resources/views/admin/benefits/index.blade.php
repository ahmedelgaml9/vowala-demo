						...
						<h2>{{trans('lang.features')}}</h2>
						  <div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>{{trans('lang.features')}}</span></li>
							</ol>
          ...
          @endif
                        ...
                        <section class="panel">
                             <header class="panel-heading">
								...
								<h2 class="panel-title">{{trans('lang.features')}}</h2>
							</header>
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="{{ url('admin/benefits/create')}}"><button id="addToTable" class="btn btn-primary">{{trans('lang.add')}}<i class="fa fa-plus"></i></button></a>
										</div>
									</div>
								</div>
