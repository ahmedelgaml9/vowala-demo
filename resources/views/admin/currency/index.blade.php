						...
						<h2>{{trans('lang.curr')}}</h2>
						  <div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>{{trans('lang.curr')}}</span></li>
							</ol>
                        ...
                        <section class="panel">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="{{ url('admin/currency/create')}}"><button id="addToTable" class="btn btn-primary">{{trans('lang.add')}}<i class="fa fa-plus"></i></button></a>
