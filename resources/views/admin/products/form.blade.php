                      ...
                      <div class="tabs tabs-vertical tabs-left">
								<ul class="nav nav-tabs  col-sm-4">
									...
									<li>
									 ...
									 <li>
									  ...
									  <li>
								    	 <a href="#colors" data-toggle="tab">{{trans('lang.colors')}}</a>
									  </li>
									  <li>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-8">
                                            <label for="blog">{{trans('lang.meta_desc')}}</label>
                                            {!!Form::text('sku',
                                ...
                                <div class="form-group">
                                    <div class="col-sm-8">
                                       <label for="name">{{trans('lang.brands')}}brand_id', $brands,null,array('class'=>'form-control','id'=>'brand_id'))!!}
                                    </div>
                                </div>
            			   	</div>
						    ...
						    <div id="sell" class="tab-pane">
                                  <div class="form-group">
                                        <div class="col-sm-8">
                                            <label for="blog"> managesstocks</label>
