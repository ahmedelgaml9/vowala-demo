						...
						<h2>{{trans('lang.blogcats')}}</h2>
						  <div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>{{trans('lang.blogcats')}}</span></li>
							</ol>
...
<section class="panel">
    <header class="panel-heading">
								...
								<h2 class="panel-title">{{trans('lang.blogcats')}}</h2>
							</header>
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="{{ url('admin/blogcat/create')}}"><button id="addToTable" class="btn btn-primary">{{trans('lang.add')}} <i class="fa fa-plus"></i></button></a>
										</div>
									</div>
								</div>
