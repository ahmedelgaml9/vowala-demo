 ...
 <div class="panel-body">
         ...
         <div class="form-group">
                ...
                <label for="title">Unit  Max Price</label>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
                ...
                <div class="form-group">
                <div class="col-sm-6">
                    <input type="checkbox" name="sidebar" value="1" id="unit">
                ...
                <div class="col-sm-6">
                    <input type="radio" name="property" value="1" id="unit">
                    <label> for sale
                    </label>
                    <br>
                </div>
                ...
                <div class="col-sm-6">
                    <input type="radio" name="property" value="2" id="unit">
                    <label > for rent
                    </label>
                    <br>
                </div>
             <div class="col-sm-6">
                    <input type="radio" name="type" value="1" id="unit">
                    <label> Primary
                    </label>
                    <br>
                </div>
                ...
                <div class="col-sm-6">
                    <input type="radio" name="type" value="2" id="unit">
                    <label > Resale
                    </label>
                    <br>
                </div>
