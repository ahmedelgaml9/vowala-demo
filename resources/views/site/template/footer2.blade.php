...
<script src="{{ asset('siteassets')}}/demo-2/assets/js/jquery.min.js"></script>
<script src="{{ asset('siteassets')}}/demo-2/assets/js/bootstrap.bundle.min.js"></script>
<script src="{{ asset('siteassets')}}/demo-2/assets/js/plugins.min.js"></script>
...
<!-- Main JS File -->
<script src="{{ asset('siteassets')}}/demo-2/assets/js/main.min.js"></script>
 <script src="{{ asset('siteassets')}}/demo-2/assets/js/nouislider.min.js"></script>
