            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb mt-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">@if($lang ==0 ){{$cat->name_ar}}  @else {{$cat->name_ar}}   @endif</li>
                    </ol>
                </div>
            </nav>
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                         <div class="boxed-slider owl-carousel owl-carousel-lazy owl-theme owl-theme-light mb-2">
                                @foreach($cat->photoes as $photo)     
                            <div class="category-slide">
                                <div class="slide-bg owl-lazy"  data-src="{{asset('admin-assets/images/subcats/'.$photo->photo)}}"></div><!-- End .slide-bg -->
                           ...
                           <div class="toolbox-left">
                            ...
                            <div class="toolbox-item toolbox-show"></div>
                              <div class="layout-modes">
                                <a href="{{url('category/'.$cat->custom_url)}}" class="layout-btn btn-grid active" title="Grid">
                                    <i class="icon-mode-grid"></i>
                                </a>
                                 <a href="{{url('categorylist/'.$cat->custom_url)}}" class="layout-btn btn-list" title="List">
