             ...
             <nav aria-label="breadcrumb" class="breadcrumb-nav">
                 <div class="container">
                     <ol class="breadcrumb mt-0">
                         ...
                         <li class="breadcrumb-item active" aria-current="page">@if($lang ==0 ){{$brand->name_ar}}  @else {{$brand->name_ar}}   @endif</li>
                      </ol>
                   </div>
               </nav>
            <div class="container">
                    ...
                    <div class="col-lg-9">
                        <div class="boxed-slider owl-carousel owl-carousel-lazy owl-theme owl-theme-light mb-2">
                            <div class="category-slide">
                                <div class="slide-bg owl-lazy"  data-src="{{asset('admin-assets/images/brands/'.$brand->photo)}}"></div>
                           ...
                           <div class="toolbox-left">
                            ...
                            <div class="toolbox-item toolbox-show">
                              ...
                              <div class="layout-modes">
                                <a href="{{url('brand/'.$brand->custom_url)}}" class="layout-btn btn-grid active" title="Grid">
                                    <i class="icon-mode-grid"></i>
                                </a>
                                 <a href="{{url('brandlist/'.$brand->custom_url)}}" class="layout-btn btn-list" title="List">
                                ...
                                <a  href="{{ url('product').'/'.$p->custom_url }}"   class="product-image">
                                 ...
                                 @if($p->type  != null) <span class="product-label label-{{$p->type}}">{{$p->type}}</span>  @endif
                                  ...
                                  <div class="product-details">
                                       ...
                                       <div class="price-box">
                                            @if($p->offer != 0 )
                                             <span class="product-price">@if ($lang == 0)  {{ $currency->name_ar }} @else {{ $currency->name }} @endif{{ $p->price -($p->price*($p->offer/100))}}</span>
                                             @else 
                                            <span class="product-price">@if ($lang == 0)  {{ $currency->name_ar }} @else {{ $currency->name }} @endif{{ $p->price }}</span>
                                             @endif          
                                            </div>
                                         </div>
                                          ...
                                          <div class="product-action">
                                            ...
                                            <a href="{{url('mywishlist')}}"  id="like{{$p->id}}"  onclick="Like({{
                                                ...
                                                <span>Add to Wishlist</span>
                                                 ...
                                                 @endif
                                                 @if($p->Quantity() > 0)
                                                 <a href="#"   onclick="AddToCartmore({{ $p->id }})"  class="paction add-cart"  title="Add to Cart">
                            ...
                            <div class="widget">
                                ...
                                <div class="collapse show" id="widget-body-1">
                                    <div class="widget-body">
                                        <ul class="cat-list">
                                              @foreach($cats as $p)
                                            <li><a href="{{ url('category').'/'.$p->custom_url }}">@if ($lang == 0) {{$p ->name_ar}} @else {{ $p->name }} @endif</a></li>
                                              @endforeach
                                        </ul>
                                    </div>
                                </div>
