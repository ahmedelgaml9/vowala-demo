                    ...
                    <div class="col-lg-9">
                         <div class="boxed-slider owl-carousel owl-carousel-lazy owl-theme owl-theme-light mb-2">
                            <div class="category-slide">
                                <div class="slide-bg owl-lazy"  data-src="{{asset('admin-assets/images/sections/'.$section->photo)}}"></div><!-- End .slide-bg -->
                        ...
                        <nav class="toolbox">
                           <div class="toolbox-left">
                               ...
                               <div class="toolbox-item toolbox-show"></div>
                                    ...
                                    @foreach($oursection as $p)
                              <div class="product product-list-wrapper">
                                    <figure class="product-image-container">
                                        <a  href="{{ url('category').'/'.$p->custom_url }}"   class="product-image">
                                            <img src="{{asset('admin-assets/images/subcats/'.$p->photo)}}" style="height:200px;"  alt="product">
                                        </a>
                                    </figure>
                        ...
                        <div class="sidebar-wrapper">
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-body-1" role="button" aria-expanded="true" aria-controls="widget-body-1">{{ trans('lang.allcategories')}}</a>
                                </h3>

                                <div class="collapse show" id="widget-body-1">
                                    <div class="widget-body">
                                        <ul class="cat-list">
                                              @foreach($section->cats  as $p)
